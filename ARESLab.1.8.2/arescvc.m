...
% criterion from a set of candidate values using k-fold Cross-Validation.
%
% Call:
%   cBest = arescvc(X, Y, trainParams, cTry, weights, k, shuffle, verbose)
%
...
for i = 1 : k
    ...
    modelBase = aresbuild(Xtr, Ytr, trainParams, w, true, [], false); % unpruned base model
    ...
    for j = 1 : cNum
        ...
        model = aresbuild(Xtr, Ytr, trainParams, w, false, modelBase, false); % pruned model
