function eq = areseq(model, precision, varNames)
% areseq
% Prints ARES model.
%
% Call:
...
% smoothing. For easier interpretation use piecewise-linear models.
%
% Input:
%   model         : ARES model
%   precision     : Optional. Number of digits in the model coefficients
%                   and knot sites. (default value = 15)
%   varNames      : Optional. A cell array of variable names to show
%                   instead of the generic ones. This is used for
...
if model.trainParams.cubic
    fprintf('\nINFO: Piecewise-cubic spline equations are very complex as they involve smoothing. For easier interpretation use piecewise-linear models.\n');
end
